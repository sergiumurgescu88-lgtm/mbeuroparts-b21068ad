const Footer = () => {
  return (
    <footer className="border-t border-border py-8 sm:py-14 px-4 sm:px-6 md:px-14 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 bg-background">
      {/* Logo */}
      <a href="#hero" className="flex items-center gap-2 sm:gap-3 no-underline">
        ...
        <span className="font-serif text-xs sm:text-sm tracking-[3px] sm:tracking-[4px] uppercase text-foreground/60">MBeuropparts</span>
      </a>

      {/* Copyright */}
      <p className="text-[10px] sm:text-xs text-muted-foreground tracking-wide text-center">
      ...
      <div className="flex items-center gap-4 sm:gap-5">
        {["M22.54 6.42a9.09 9.09 0 00-3.55-2.94A9 9 0 0012 2.96a8.86 8.86 0 00-4.29 1.1A9.09 9.09 0 004.16 7a8.86 8.86 0 00-1.1 4.29v.41a9 9 0 001.46 4.5 9 9 0 003.88 3.34 9 9 0 004.6 1.21c.7 0 1.39-.09 2.06-.26a1.13 1.13 0 00.82-.86 1.13 1.13 0 00-.35-1.07l-.08-.07a7 7 0 01-2.45.44 7 7 0 01-3.58-.98A7.06 7.06 0 016 14.34a7 7 0 01-.5-3.63 7 7 0 011.62-3.31A7.06 7.06 0 0110.32 5a7 7 0 013.63-.5 7 7 0 013.31 1.62A7.06 7.06 0 0119.67 9.3a7 7 0 01.5 3.63 7 7 0 01-1.62 3.31 1.13 1.13 0 00.09 1.6l.06.05a1.13 1.13 0 001.5-.08 9 9 0 002.34-4.6 9 9 0 00-.01-4.79z"].map((d, i) => (
          <button key={i} className="w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-border flex items-center justify-center text-muted-foreground cursor-pointer hover:border-primary hover:text-primary hover:-translate-y-0.5 transition-all">
